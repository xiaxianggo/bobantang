...
//@property (strong, nonatomic, readwrite) RESideMenu *sideMenuViewController;
@end
...
{
    [BBTPreferences sharedInstance];    //setup preferences
    ...
    [[UITabBar appearance] setTintColor:[UIColor BBTAppGlobalBlue]];
    [[UITabBar appearance] setBarTintColor:[UIColor whiteColor]];
    [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
    
    // Set viewControllers and Window
    self.window.backgroundColor = [UIColor whiteColor];
    [self.window makeKeyAndVisible];
    self.window.rootViewController = [UIViewController BBTAppRootViewController];
    
    // Set up JPush
#if __IPHONE_OS_VERSION_MAX_ALLOWED > __IPHONE_7_1
    if ([[UIDevice currentDevice].systemVersion floatValue] >= 8.0) {
        [APService registerForRemoteNotificationTypes:(UIUserNotificationTypeSound |
    ...
    [[UIApplication sharedApplication] setApplicationIconBadgeNumber:0];    // clear badge number
